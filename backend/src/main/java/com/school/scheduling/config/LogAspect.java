...
import com.school.scheduling.util.CreatJsonFile;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * com.school.scheduling.controller.*.*(..))")
    public void log() {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        Map<String, String[]> paramsArray = request.getParameterMap();//=>{id:[1]}形式
